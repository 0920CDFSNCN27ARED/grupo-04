...
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (1, 'Giana', 'Maliphant', 'gmaliphant0@ebay.com', 'NVHkryudE', 'Saint Louis', 'Missouri', 'Park Meadow', '6404', 6, "A", '314-384-3956', 'NuncProinAt.tiff', 1, 0);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (2, 'Delmore', 'Hansana', 'dhansana1@last.fm', 'WpO1GGrq', 'San Antonio', 'Texas', 'Cordelia', '380', 20, "B", '210-562-4264', 'Odio.tiff', 2, 0);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (3, 'Reinhard', 'Wederell', 'rwederell2@jigsy.com', 'JryhJlA', 'New Castle', 'Pennsylvania', 'Village', '14716', 10, "C", '724-376-9424', 'Aenean.tiff', 2, 1);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (4, 'Heath', 'Tincombe', 'htincombe3@engadget.com', '4gBEvlI9mxNd', 'Arlington', 'Virginia', 'Del Mar', '7494', 12, "D", '703-530-9202', 'AliquetAtFeugiat.tiff', 2, 0);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (5, 'Virgilio', 'Leverentz', 'vleverentz4@topsy.com', 'kKVimU', 'Savannah', 'Georgia', 'Dixon', '2', 14, "A", '912-398-3613', 'Nunc.jpeg', 1, 1);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (6, 'Nona', 'Fladgate', 'nfladgate5@opensource.org', 'x8k8asZ', 'Laredo', 'Texas', 'Warner', '5120', NULL, NULL, '956-298-2610', 'CurabiturConvallisDuis.tiff', 1, 1);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (7, 'Findlay', 'Stookes', 'fstookes6@wisc.edu', 'hzdKM33Iv7', 'Pasadena', 'California', 'Farragut', '23', 8, "F", '626-775-4300', 'LoremIntegerTincidunt.gif', 2, 1);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (8, 'Skelly', 'Filippov', 'sfilippov7@diigo.com', 'O4vUMx2i', 'Grand Rapids', 'Michigan', 'Oak', '71', 14, "B", '616-949-3774', 'ConsequatLectus.tiff', 1, 1);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (9, 'Sheila-kathryn', 'Lippini', 'slippini8@cbc.ca', 'gDm3B5', 'Phoenix', 'Arizona', 'Gerald', '552', 7, "C", '602-151-2611', 'Velit.tiff', 1, 1);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (10, 'Sauveur', 'Gadie', 'sgadie9@newsvine.com', 'fplQHB3rdzC6', 'Austin', 'Texas', '5th', '8', 1, "A", '512-179-6710', 'Lobortis.jpeg', 1, 1);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (11, 'Ivory', 'Croser', 'icrosera@vk.com', 'pBySWRoXRJ', 'Worcester', 'Massachusetts', 'Dorton', '48842', NULL, NULL, '508-613-2107', 'AmetSapienDignissim.jpeg', 1, 1);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (12, 'Jan', 'Brownell', 'jbrownellb@lulu.com', 'X4jXuK08F', 'Orlando', 'Florida', 'Di Loreto', '7', 1, "D", '321-409-7996', 'AmetNuncViverra.tiff', 2, 1);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (13, 'Kippy', 'Pettingall', 'kpettingallc@is.gd', 'VWT4xqejQ', 'Louisville', 'Kentucky', 'Sutteridge', '9569', 15, "B", '502-584-1046', 'PotentiInEleifend.jpeg', 1, 0);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (14, 'Georgine', 'Gilhouley', 'ggilhouleyd@woothemes.com', 'bjEq6Voc3nXq', 'Jefferson City', 'Missouri', 'Sugar', '07', 11, "C", '573-253-1721', 'NibhFusceLacus.jpeg', 2, 0);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (15, 'Waverley', 'Warlawe', 'wwarlawee@opensource.org', 'njdPaxCPV', 'Greenville', 'South Carolina', 'Menomonie', '697', NULL, NULL, '864-493-9940', 'UtDolor.tiff', 1, 0);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (16, 'Kenneth', 'Pilsbury', 'kpilsburyf@soundcloud.com', 'nr2tyXf', 'Aurora', 'Colorado', 'Bultman', '25', 11, "B", '303-616-3160', 'Nulla.tiff', 1, 1);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (17, 'Merlina', 'Goggen', 'mgoggeng@wunderground.com', '6rylqA1gqvAF', 'Charleston', 'West Virginia', 'Donald', '421', 15, "D", '304-676-2051', 'AnteIpsum.jpeg', 1, 0);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (18, 'Jeannie', 'Geertz', 'jgeertzh@de.vu', 'vWjqisPhg4', 'Boynton Beach', 'Florida', 'Shopko', '82', 4, "B", '561-930-9190', 'InFaucibusOrci.jpeg', 1, 0);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (19, 'Arman', 'Leneve', 'alenevei@scribd.com', 'QCqGzR', 'Lexington', 'Kentucky', 'Colorado', '42110', 12, "A", '859-210-2078', 'Morbi.jpeg', 1, 0);
insert into users (id, firstName, lastName, email, password, city, state, street, houseNumber, floor, apartment, phoneNumber, avatar, categoryId, isBanned) values (20, 'Caroline', 'Harkins', 'charkinsj@51.la', 'kusSXfB0h', 'South Bend', 'Indiana', 'Parkside', '20', 12, "C", '574-875-6366', 'QuisAugueLuctus.tiff', 1, 1);

UPDATE users SET avatar = "ce2a95e99faceaf7af19c273b10ebcc1.jpg";
...
UPDATE products 
SET image = "img-cafetera-moulinex.jpg";
